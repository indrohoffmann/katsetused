...
* Updated: Blocks and Editor Blocks css updated

= 2.3 (Released: February 10, 2022) =
* Updated: WordPress 5.9 ready

= 2.2.3 (Released: April 18, 2021) =
* Bug Fixed: Header Video Issue from last update

= 2.2.2 (Released: March 22, 2021) =
* Bug Fixed: Header Video Issue

= 2.2.1 (Released: October 12, 2020) =
* Updated: Screenshot

= 2.2 (Released: August 22, 2020) =
* Bug Fixed: Sidebar issue on archive page in child themes
* Updated: Readme

= 2.1 (Released: July 26, 2020) =
* Added: Search text option
* Bug Fixed: Theme Check Issues
* Updated: Screenshot
* Updated: Header Image

= 2.0.6 (Released: March 27, 2020) =
* Bug Fixed: Removed unnecessary enqueue script for navigation.min.js file
...
Fotografie Pro WordPress Theme, Copyright 2012-2022 Catchthemes.com
...
* Images used are released under the CC0 license
	** Screenshot Images:
	- https://stocksnap.io/photo/girl-woman-OCEKCHHED5
	- https://stocksnap.io/photo/people-girl-ZT9WYAA3Y2
	- https://stocksnap.io/photo/laptop-electronic-ZXOBOKAJEQ
	- https://stocksnap.io/photo/blonde-hair-I1O9OZLVCS
	** Header Image:
	- https://stocksnap.io/photo/people-woman-BJ05BEM6K5
