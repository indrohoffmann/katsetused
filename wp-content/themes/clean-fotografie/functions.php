...
function cleanfotografie_scripts() {
	...
	wp_enqueue_style( 'cleanfotografie-style', get_stylesheet_uri(), null, date( 'Ymd-Gis', filemtime( get_template_directory() . '/style.css' ) ) );
...
function cleanfotografie_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Newsletter', 'clean-fotografie' ),
		'id'            => 'sidebar-newsletter',
		'description'   => esc_html__( 'This is for Newsletter Template Widget Area.', 'clean-fotografie' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>'
